# python -m benchmarks.bdas_cell_8 -s DAG  -K 8 -d 23
import csv
import json
import os
...
for trial in range(max_cell):
    ...
    for t, action in enumerate(actions, 1):
        ...
        sns_arrs.append([K, trial + 1, reward])
...
result_json['record dict'] = record_dict
result_json['sns record'] = sns_arrs
