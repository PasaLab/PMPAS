# python -m benchmarks.ea_iter --max_iter=1000 -d 11
import json
import os
...
RESULTS_SAVED_PATH = f"ea_{space}_cell_{max_cell}_{time_str}_max_iter_{max_iter}_data_{data}_k_fold_{kth}"
...
# initializing search_space instance # 生成问题对象
if space == 'DAG':
