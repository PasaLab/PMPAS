...
from core.utils.env_util import environment_init, split_validation_data, get_bdas_time_args
...
RESULTS_SAVED_PATH = f"bdas_{time_str}_{space}_{K}_total_time_{total_time}_data_{data}_fold{kth + 1}"
