...
class Cascade:
    ...
    def __init__(self, child, k_fold=3, max_layers=float("inf"), tolerance=0, early_stopping_rounds=3,
                 random_state=None, cell_time_limit=None, confidence_screen=False):
        """
...
if __name__ == '__main__':
    ...
    model = [0, 'RandomForestClassifier', 1, 'RandomForestClassifier', 0, 'RandomForestClassifier', 3,
             'RandomForestClassifier', 0, 'ExtraTreesClassifier', 4, 'ExtraTreesClassifier', 0,
